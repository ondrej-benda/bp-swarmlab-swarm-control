                ...
                if self.plot_initialized == 0 % Init plot
                    ...
                    elseif self.viewer_type == "agent" % Draw agents
                        ...
                        if self.draw_waypoints
                            waypoints_ned = swarm.get_waypoints_ned();
                            pn = [pn,waypoints_ned(1,:)];
                            pe = [pe,waypoints_ned(2,:)];
                            pd = [pd,waypoints_ned(3,:)];
                            size_agents=[size_agents;repmat(300, swarm.nb_agents, 1)];
