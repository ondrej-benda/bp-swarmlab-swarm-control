...
%         map.gass_center=is_in_object(map,map.gass_center);
        ...
        %Evolucni algo
            ...
            fitness_mapy=spocti_body_roj(swarm);
            disp([num2str(generace),'.',num2str(iterace),'.',num2str(mapa),':Kolize_agent: ',num2str(sum(swarm.collisions_history(:,1))),'Kolize_obs: ',num2str(sum(swarm.collisions_history(:,2))),' Body ',num2str(fitness_mapy),'(',num2str(swarm.pocet_splnenych),')']);
