...
pocet_sad=24;
pocet_map=5;
rozsah_parametru=[0,5;0,5;5,100;0.5,5;0,0.5;10,p_sim.end_time];
...
while true
    ...
    pso.d=hodnoty_parametru(iterace,1);
    pso.s=hodnoty_parametru(iterace,2);
    pso.radius_seeking=hodnoty_parametru(iterace,3);
    
    pso.w_max=hodnoty_parametru(iterace,4);
    pso.w_min=hodnoty_parametru(iterace,5);
    pso.t_max=hodnoty_parametru(iterace,6);
