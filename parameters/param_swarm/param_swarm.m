...
p_swarm.goal_of_swarm=[map.width/2;map.width/2];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Number of agents
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p_swarm.r_coll = 0.5;%0.5 %poloměr agenta slouzici k vypoctu kolize
...
%         repmat(cylinder_radius, 1, nb_obstacles)]; % r_obstacle
    ...
    map.buildings_north'; % x_obstacle
    map.buildings_east'; % y_obstacle
    map.building_width' / 2]; % r_obstacle
...
p_swarm.P0 = [0,map.width/2,-50]'; % [m] position of a vertex of the cube
